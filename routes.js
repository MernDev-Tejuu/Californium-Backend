...
const newAuthor_controller = require('../routes/controller/newAuthor') 
const newBook_controller = require('./controller/newBook') 
const newPublisher_controller = require('./controller/newPublisher')
...
//Roll no 9 Session/Reference & Populate
app.post('/newAuthor', newAuthor_controller.createAuthor)
app.post('/newBook',newBook_controller.createBook)
app.post('/newPublisher',newPublisher_controller.createPublisher)
app.get('/getBooks',newBook_controller.getAllBooks_Author)
module.exports=app        